...
class Renderer_OpenVDBRenderExampleConvert final : public Renderer {
private:
    Scene* scene_;
    Film* film_;
...
LM_COMP_REG_IMPL(Renderer_OpenVDBRenderExampleConvert, "renderer::openvdb_render_example_convert");
